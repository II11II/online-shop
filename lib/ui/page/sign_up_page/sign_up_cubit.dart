...
class SignUpCubit extends Cubit<SignUpState> {
  ...
  Future register(String phone, String password, String email) async {
    try {
      emit(SignUpState.copyWith(
        state,
        state: NetworkState.LOADING,
      ));
      Profile profile = await repo.register(email, password, phone);
      repo.saveUserToken(profile.token);
      emit(SignUpState.copyWith(
        state,
